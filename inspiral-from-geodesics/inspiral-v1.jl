# Solve for inspiral orbit using e, p, and ι from solving 
...
ri = 11.295
θi = π/2
e = 0.1837114050455181  # From solving geodesic equations
p = 9.219986073495972
ι = 0.2968042067761252
saveepιfluxes = true   # Specify whether to save orbital parameters
...
function calculateELQ(mass, spin, littlemass, finalvel, finalpos)
    utf = finalvel[1]
    uθf = finalvel[3]
    uϕf = finalvel[4]
...
while (round(initialposnew[2], digits=5) > round(1.05*horizon, digits=5)) 
    ...
    E, Lz, Q = calculateELQ(mass, spin, littlemass, initialvelnew, initialposnew)
...
# Interpolate and save inspiral orbit
...
CSV.write("inspiral-orbit-v1.csv", df1)
...
if saveepιfluxes
    ...
    CSV.write("inspiral-fluxes-v1.csv", df2)
end